...
public class Main
{
    private static Logger loggerCorrect;
    private static Logger loggerIncorrect;
    ...
    public static void main(String[] args)
    {
        ...
        loggerCorrect = LogManager.getLogger("CORRECT");
        loggerIncorrect = LogManager.getLogger("INCORRECT");
        ...
        for(;;)
        {
            try {
                ...
                loggerCorrect.info("Запрос: " + from + " - " + to);
